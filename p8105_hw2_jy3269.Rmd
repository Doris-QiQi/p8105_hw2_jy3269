...
mr <- data_2 %>% 
  ...
  mutate(mr,origin = "A",.before = "dumpster") %>% 
  unite("ID",origin : dumpster,sep = "")
...
```{r}
data_3 <- read_excel("./data/Trash Wheel Collection Data.xlsx",range = "A2:N97",sheet="Professor Trash Wheel")
